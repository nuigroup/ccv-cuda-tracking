/*
// This source file is an example of using this gpu library.
...
//	bool flag = true; // It is used to capture only first frame as background. 
	...
	cvMoveWindow( "Amplify", 0, 600);

	cvNamedWindow( "Threshold", 0 );
	cvMoveWindow( "Threshold", 340, 600);

	cvNamedWindow( "Blobs", 0 );
	cvMoveWindow( "Blobs", 680, 600);
