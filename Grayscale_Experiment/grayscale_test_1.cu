/*
This is a grayscale experiment with pinned host memory. Though performance has increased by 25%
still it cant be commited to main grayscale code. Reason for this is the declaration of pinned memory outside
gpu_grayscale.cu file inside the grayscale_test.cpp. This cant be done because opencv + Cuda are not compatible. :(
*/
...
int main( int argc, char** argv )
{
	...
	cudaHostAlloc((void **)&buffer, (320*240*4), cudaHostAllocWriteCombined);
